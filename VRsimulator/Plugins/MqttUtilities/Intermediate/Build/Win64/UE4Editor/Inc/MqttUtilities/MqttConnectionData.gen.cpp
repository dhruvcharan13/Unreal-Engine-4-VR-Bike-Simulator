...
class UScriptStruct* FMqttConnectionData::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern MQTTUTILITIES_API uint32 Get_Z_Construct_UScriptStruct_FMqttConnectionData_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FMqttConnectionData, Z_Construct_UPackage__Script_MqttUtilities(), TEXT("MqttConnectionData"), sizeof(FMqttConnectionData), Get_Z_Construct_UScriptStruct_FMqttConnectionData_Hash());
	}
	return Singleton;
}
...
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FMqttConnectionData(FMqttConnectionData::StaticStruct, TEXT("/Script/MqttUtilities"), TEXT("MqttConnectionData"), false, nullptr, nullptr);
static struct FScriptStruct_MqttUtilities_StaticRegisterNativesFMqttConnectionData
{
	FScriptStruct_MqttUtilities_StaticRegisterNativesFMqttConnectionData()
	{
		UScriptStruct::DeferCppStructOps<FMqttConnectionData>(FName(TEXT("MqttConnectionData")));
	}
} ScriptStruct_MqttUtilities_StaticRegisterNativesFMqttConnectionData;
	...
	uint32 Get_Z_Construct_UScriptStruct_FMqttConnectionData_Hash() { return 2639793362U; }
