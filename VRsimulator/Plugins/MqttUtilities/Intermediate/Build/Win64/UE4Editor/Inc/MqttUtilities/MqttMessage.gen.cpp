...
class UScriptStruct* FMqttMessage::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern MQTTUTILITIES_API uint32 Get_Z_Construct_UScriptStruct_FMqttMessage_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FMqttMessage, Z_Construct_UPackage__Script_MqttUtilities(), TEXT("MqttMessage"), sizeof(FMqttMessage), Get_Z_Construct_UScriptStruct_FMqttMessage_Hash());
	}
	return Singleton;
}
...
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FMqttMessage(FMqttMessage::StaticStruct, TEXT("/Script/MqttUtilities"), TEXT("MqttMessage"), false, nullptr, nullptr);
static struct FScriptStruct_MqttUtilities_StaticRegisterNativesFMqttMessage
{
	FScriptStruct_MqttUtilities_StaticRegisterNativesFMqttMessage()
	{
		UScriptStruct::DeferCppStructOps<FMqttMessage>(FName(TEXT("MqttMessage")));
	}
} ScriptStruct_MqttUtilities_StaticRegisterNativesFMqttMessage;
	...
	uint32 Get_Z_Construct_UScriptStruct_FMqttMessage_Hash() { return 1678263525U; }
